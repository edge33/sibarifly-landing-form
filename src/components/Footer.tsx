const Footer = () => {
  return (
    <footer className="print:hidden sm:flex sm:items-center sm:justify-between p-4 sm:p-6 xl:p-8 antialiased">
      ...
      <div className="flex justify-center items-center space-x-1">
        <a
          href="https://www.facebook.com/SibariFly"
          target="_blank"
        ...
        <a
          href="https://www.instagram.com/aeroclubsibarifly/"
          target="_blank"
          className="inline-flex justify-center p-2 text-gray-500 rounded-lg cursor-pointer dark:text-gray-400 dark:hover:text-white hover:text-gray-900 hover:bg-gray-100 dark:hover:bg-gray-600"
        >
          <svg
